...
/**
 * Legacy component generator: Angular's standalone OnPush component plus the
 * angular-django2 embedding hooks.
 *
 * @internal
 */
export function generateComponent(options: JsonObject): Rule {
