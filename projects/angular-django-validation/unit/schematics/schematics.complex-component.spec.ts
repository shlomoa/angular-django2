...
describe('complex-component schematic', () => {
  ...
  it('TC-COMPLEX-01: composes component and embed-component for all advanced features', async () => {
    ...
    expect(parent).toContain(
      'Projection BKM: Project multiple sibling elements via <ng-container dashboard-card-actions>',
    );
    expect(parent).toContain(
    ...
    expect(template).toContain(
      '<!-- Projection slots (BKM: project multiple elements via <ng-container dashboard-card-actions>',
    );
