...
describe('angular-django2 schematics', () => {
  ...
  describe('material-app schematic', () => {
    ...
    it('TC-APP-01: adds Material dependencies and generates the sidenav layout', () => {
      ...
      // Verify Material layout was generated without intermediate wrapper div
      ...
      expect(appComponentHtml).toContain(
        '<mat-sidenav-content>\n    <router-outlet />\n  </mat-sidenav-content>',
      );
      expect(appComponentHtml).not.toContain('<div class="content">');

      const appComponentScss = tree.read('projects/my-app/src/app/app.component.scss')!.toString();
      expect(appComponentScss).not.toContain('.content');
    ...
    it('TC-APP-02: uses the given project name when generating the layout', () => {
      ...
      const appComponentHtml = tree
        .read('projects/test-app/src/app/app.component.html')!
        .toString();
      expect(appComponentHtml).toContain(
        '<mat-sidenav-content>\n    <router-outlet />\n  </mat-sidenav-content>',
      );
