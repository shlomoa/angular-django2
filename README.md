...
| `ng generate angular-django2:reactive-form <name> --definition=<file>`                     | Creates a typed Material reactive form from a JSON definition                                        | Create-only; composes local field primitives and maps Django REST Framework errors                 |
