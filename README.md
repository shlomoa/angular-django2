...
| `ng generate angular-django2:openapi-setup --inputPath=<file>`                       | Bootstraps `ng-openapi-gen` and Django integration helpers                                           | Adds `generate:api` script and auth/CSRF/transport + resource adapter helpers                 |
