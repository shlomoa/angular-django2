...
software and not yet alpha. The current package version is `0.4.1`.
...
| `ng generate angular-django2:site --project=<name> --source=<file>`                        | Assembles an OpenUI-defined Material site in an existing Material app                                | Requires the known `material-app` shell; routes/forms remain separate owned outputs                |
