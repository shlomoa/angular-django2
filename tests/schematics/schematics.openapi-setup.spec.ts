...
describe('angular-django2 schematics', () => {
  describe('openapi-setup schematic', () => {
    it('TC-API-01: adds ng-openapi-gen to devDependencies', () => {
      ...
      const updatedTree = openapiSetup({})(tree, context) as Tree;
    ...
    it('TC-API-03: generates ng-openapi-gen.json config file with custom options', () => {
      ...
      const updatedTree = openapiSetup({
        openapiSpecFile: 'schema/api.json',
    ...
    it('TC-API-05: is idempotent when run multiple times', () => {
      ...
      // First run
      let updatedTree = openapiSetup({})(tree, context) as Tree;
      ...
      // Second run
      updatedTree = openapiSetup({})(updatedTree, context) as Tree;
    ...
    it('TC-API-06: handles missing package.json gracefully', () => {
      ...
      // Should not throw
      expect(() => openapiSetup({})(tree, context)).not.toThrow();
    ...
    it('TC-API-12: honors custom helpersPath', () => {
      ...
      const updatedTree = openapiSetup({ helpersPath: 'src/app/core/api' })(tree, context) as Tree;
    ...
    it('TC-API-13: skipHelpers suppresses helper generation', () => {
      ...
      const updatedTree = openapiSetup({ skipHelpers: true })(tree, context) as Tree;
    ...
    it('TC-API-14: skipTests omits generated spec files', () => {
      ...
      const updatedTree = openapiSetup({ skipTests: true })(tree, context) as Tree;
