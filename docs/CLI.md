...
| `ng generate angular-django2:component <name>`                   | Generate a standalone OnPush component.                                     | Project-relative `--path`, `--project`, `--standalone` default `true`, `--changeDetection` default `OnPush`.                               |
